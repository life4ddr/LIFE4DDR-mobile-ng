...
object TrialTypeSerializer: KSerializer<TrialType> {
    override val descriptor = PrimitiveSerialDescriptor("trialType", PrimitiveKind.STRING)
    override fun deserialize(decoder: Decoder) = TrialType.valueOf(decoder.decodeString().uppercase())
    override fun serialize(encoder: Encoder, value: TrialType) = encoder.encodeString(value.name.lowercase())
}
