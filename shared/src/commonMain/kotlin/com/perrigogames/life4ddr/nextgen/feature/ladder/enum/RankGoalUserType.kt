...
enum class RankGoalUserType(
    ...
    LEVEL_12("12", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 12)),
    LEVEL_13("13", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 13)),
    LEVEL_14("14", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 14)),
    LEVEL_15("15", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 15)),
    LEVEL_16("16", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 16)),
    LEVEL_17("17", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 17)),
    LEVEL_18("18", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 18)),
    LEVEL_19("19", StringDesc.ResourceFormatted(MR.strings.rank_goal_category_level, 19)),
