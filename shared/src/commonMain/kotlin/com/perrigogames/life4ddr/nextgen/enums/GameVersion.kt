...
object GameVersionSerializer: KSerializer<GameVersion> {
    override val descriptor = PrimitiveSerialDescriptor("gameVersion", PrimitiveKind.LONG)
    override fun deserialize(decoder: Decoder) = GameVersion.parse(decoder.decodeLong())!!
    override fun serialize(encoder: Encoder, value: GameVersion) = encoder.encodeLong(value.stableId)
}
