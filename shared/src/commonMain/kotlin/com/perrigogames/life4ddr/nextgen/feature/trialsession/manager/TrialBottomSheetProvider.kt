...
//    }
    ...
    fun shortcuts(songId: String) = listOf(
        UITrialBottomSheet.Shortcut(
            ...
            TrialSessionInput.UseShortcut(songId, ShortcutType.MFC)
        ),
        UITrialBottomSheet.Shortcut(
            MR.strings.clear_pfc.desc(),
            TrialSessionInput.UseShortcut(songId, ShortcutType.PFC)
        ),
        UITrialBottomSheet.Shortcut(
            MR.strings.clear_gfc.desc(),
            TrialSessionInput.UseShortcut(songId, ShortcutType.GFC)
        )
    )
}